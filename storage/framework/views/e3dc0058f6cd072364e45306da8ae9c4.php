<div class="relative bg-indigo-200 dark:bg-indigo-500 p-4 sm:p-6 rounded-sm overflow-hidden mb-8">
    ...
    <div class="relative">
        <h1 id="greeting" class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold mb-1">Good <span
                id="timeOfDay" class="font-semibold"></span>, <?php echo e(Auth::user()->name); ?> 👋</h1>
        <p class="dark:text-indigo-200">Lets Work For Your Future 👩‍💻</p>
    </div>
</div>

<!-- Load JavaScript -->
<script src="<?php echo e(asset('js/greeting.js')); ?>"></script>
<?php /**PATH C:\laragon\www\project-auth-dssapp-main\resources\views/components/dashboard/welcome-banner.blade.php ENDPATH**/ ?>
...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    <div
        class="origin-top-right z-10 absolute top-full -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 py-1.5 rounded shadow-lg overflow-hidden mt-1 <?php echo e($align === 'right' ? 'right-0' : 'left-0'); ?>"                
...
</div><?php /**PATH C:\laragon\www\project-auth-dssapp-main\resources\views/components/dropdown-notifications.blade.php ENDPATH**/ ?>